...
function ExpenseItem(props) {
  ...
  return (
    ...
    <Card className="expense-item">
      ...
      >Click me</button> */}
      {/* we dont write clickHandler() because it will be executed when this JSX is parsed not not when the button is clicked, we just pass the pointer to function which determines what to execute when the click occurs */}
    </Card>
    </li>
  );
